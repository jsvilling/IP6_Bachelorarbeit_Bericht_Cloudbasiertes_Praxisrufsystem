...
%%---TEXT--------------------------------------------------------------------------------
    ...
    \include{sections/02_project_plan/02_project_plan}
    \include{sections/03_requirements/03_requirements}
    \include{sections/04_evaluation/04_evaluation}
    \include{sections/05_concept/05_concept}
    \include{sections/06_results/06_results}
    \include{sections/07_end/07_end}


%%---APPENDIX----------------------------------------------------------------------------
    \include{sections/99_appendix/99_appendix}

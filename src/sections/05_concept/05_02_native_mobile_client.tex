...
Anbindung nötig für Configuration, Notification, Speech Synth und Signaling.
Configuration, Notification und Speech Synth Anbindung findet über REST/HTTP statt.
Signaling findet über Websocket Anbindung statt.
Das wird im Signaling Kapitel beschrieben.

Basisklasse bietet URLSession Klasse für Rest Requests.
Keine hüschen Http Client.
Deshalb machen wir selber einen.
Ein zentraler API Service wird erstellt.
Bietet Methoden generische Methoden für GET, POST, PUT und DELETE an.
...
Typ für Fehlerfall ist immer PraxisrufApi.

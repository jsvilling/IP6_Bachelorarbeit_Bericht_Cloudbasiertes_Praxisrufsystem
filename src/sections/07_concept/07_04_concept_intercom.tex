...
Mit der Integration von synchroner Sprachübertragung wird Praxisruf um die Funktion Gegensprechanlage erweitert.
...
Damit dies möglich ist, sind Änderungen an dem Configuration-Modul des Cloudservice sowie am Admin UI notwendig.
...
Gleichzeitig wird der Cloudservice um Http-Endpunkte für das Lesen, Erstellen, Aktualisieren und Löschen von CallTypes erweitert.
...
Abbildung 7.15 zeigt das Klassendiagramm der dazu umgesetzten Komponenten.
...
Das Modul Signaling muss zwei Aufgaben übernehmen.
...
Kann eine Signalmeldung nicht zugestellt werden, muss der betroffenen Empfänger über das verpasste Signal informiert werden.
...
Diese führt eine Liste bekannter Verbindungen und bietet Methoden, um Verbindungen zu registrieren und wieder zu entfernen.
...
\begin{figure}[h]
    ...
    \begin{minipage}[b]{0.9\textwidth}
        ...
        \caption{Sequenzdiagramm - Anmeldung und Registrierung}
    \end{minipage}
\end{figure}
...
Dabei wird beschrieben wie diese aufgebaut sind und welche Rolle sie im System erfüllen.
...
\begin{tabbing}
    ...
    Unavailable
    \> \> \> Wenn die Signaling Instanz ein Signal nicht zustellen kann, wird ein Unavailable-
    ...
    \\ \> \> \> lungen deaktiviert ist oder bereits ein Anruf aktiv ist, sendet der Mobile Client ein
...
Der Austausch von Ice Candidate Meldungen wird so lange wiederholt, bis sich beide Seiten einer Verbindung auf Verbindungsdetails geeinigt haben.
...
In Kapitel 7.2.2 wird die Klasse PraxisrufApi beschrieben.
...
Abbildung 7.19 zeigt das Klassendiagramm dieser Komponenten.
...
Die Geräte können ICE Candidates für direkte Kommunikation im lokalen Netzwerk austauschen.
...
Dies vereinfacht den Aufbau von Verbindungen.
Es erlaubt, neben der Signaling Instanz keine weitere Infrastruktur betreiben zu müssen.

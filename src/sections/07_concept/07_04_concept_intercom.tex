...
%
%Anrufe über die Gegensprechanlage können nur empfangen werden, solange die Applikation im Vordergrund läuft und eine Verbindung zur Signaling Instanz hergestellt hat.
%Ist dies nicht der Fall können keine Signale empfangen werden.
...
%Die technische Identifikation dieses Benachrichtigungstyps muss anschliessend in den Umgebungsvariablen des Signalingservices hinterlegt werden.
